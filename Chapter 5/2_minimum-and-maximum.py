...
class Tree():
    ...
    def find_minimum(self):
        ...
        """
        # Aloitetaan looppaaminen rootista
        current_node = self._root_node
        
        if current_node is None:
            return None
        
        # Niin kauan kun on left childeja eli pienempiä (tai yhtäsuuria) nodeja, jatketaan looppaamista
        while current_node._left_child:
            current_node = current_node._left_child
        
        # Palautetaan pienin arvo
        return current_node
    ...
    def find_maximum(self):
        ...
        # Niin kauan kun on right puolen childeja (eli isompia tai yhtäsuuria) nodeja, loopataan
